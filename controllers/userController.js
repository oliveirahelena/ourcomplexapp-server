...
exports.apiDoesUsernameExist = function (req, res) {
...
exports.apiDoesEmailExist = async function (req, res) {
  let emailBool = await User.doesEmailExist(req.body.email)
  res.json(emailBool)
}

exports.apiSharedProfileData = async function (req, res, next) {
  let viewerId
  try {
...
exports.apiProfileBasicData = function (req, res) {
  res.json({
    profileUsername: req.profileUser.username,
    profileAvatar: req.profileUser.avatar,
    isFollowing: req.isFollowing,
...
exports.apiProfileFollowers = async function (req, res) {
  try {
    let followers = await Follow.getFollowersById(req.profileUser._id)
...
exports.apiProfileFollowing = async function (req, res) {
  try {
    let following = await Follow.getFollowingById(req.profileUser._id)
